...
def more_boar(player_score, opponent_score):
    ...
    "*** YOUR CODE HERE ***"
    if len(player_str) ==1 or len(opponent_str)==1:
        if len(player_str)==1:
            player_str='0'+player_str
        if len(opponent_str)==1:
            opponent_str='0'+opponent_str
    if player_str[0]<opponent_str[0] and player_str[1]<opponent_str[1]:
        return True
    else:
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==0:
            ...
            while more_boar(score0,score1) and score0<100:
            ...
            while more_boar(score1,score0) and score1<100:
                say = say(score0, score1)
                rolls=strategy1(score1,score0)
                score1+=take_turn(rolls,score0,dice)
        say=say(score0,score1)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def say(score0,score1,lastscore=last_score,runninghigh=running_high):
        if who==0:
            diff=score0-lastscore
            lastscore=score0

        elif who==1:

            diff = score1-lastscore
            lastscore=score1

        if diff>runninghigh:
            runninghigh=diff
            print('Player',who,'has reached a new maximum point gain.',runninghigh,'point(s)!')
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in range(10):
        ...
        result.append(average_roll(i+1,dice))
