...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        current_formals, current_val = formals, vals
        while current_formals is not nil:
            new_frame.define(current_formals.first, current_val.first)
            current_formals, current_val = current_formals.rest, current_val.rest
        return new_frame
        # END PROBLEM 10
...
def do_and_form(expressions, env):
    ...
    4
    False
    >>> do_and_form(read_line("((+ 1 1) 1)"), env)
    1
    """
